...
[![version](https://img.shields.io/badge/version-0.5.7-c9a227?style=flat-square)](https://github.com/pocketgeek/tak-engine/releases)
...
**Version 0.5.7** — reported by `takclient --version` and `takserver --version`
