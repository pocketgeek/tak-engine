...
[![version](https://img.shields.io/badge/version-0.5.8-c9a227?style=flat-square)](https://github.com/pocketgeek/tak-engine/releases)
...
**Version 0.5.8** — reported by `takclient --version` and `takserver --version`
