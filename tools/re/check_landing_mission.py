...
def main():
    ...
    for i in range(2048):
        ...
        canceled=i%17==0;mover_on=i%7!=0;fly=i%11!=0;velocity=rng.randrange(101);height=rng.randrange(600);accept=(i//5)%15-1
